...
const OrderPod = ({ title, orders, onDeleteSelected, onPlaceOrders }) => {
  ...
  const handleDeleteOrder = (itemID) => {
    axios
      .put(
        `https://theplaceisyours.club/api/orders/handleCancelOrder`,
        { itemID: itemID },
        config
      )
      .then((response) => {
  ...
  const handleSpecialDeleteOrder = (itemID, itemSize) => {
    axios
      .put(
        `https://theplaceisyours.club/api/orders/handleSpecialCancelOrder`,
  ...
  const handlePlaceOrderProc = (itemID) => {
    axios
      .put(
        `https://theplaceisyours.club/api/orders/handlePendingProcessing`,
        {
          itemID: itemID,
        },
        config
  ...
  const handlePlaceOrderPay = (itemID) => {
    axios
      .put(
        `https://theplaceisyours.club/api/orders/handlePendingPayment`,
        {
          itemID: itemID,
        },
        config
  ...
  const handleSpecialPlaceOrderProc = (itemID) => {
    axios
      .put(
        `https://theplaceisyours.club/api/orders/handleSpecialPendingProcessing`,
        {
          itemID: itemID,
        },
        config
  ...
  const handleSpecialPlaceOrderPay = (itemID) => {
    axios
      .put(
        `https://theplaceisyours.club/api/orders/handleSpecialPendingPayment`,
        {
          itemID: itemID,
        },
        config
